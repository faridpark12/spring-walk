...
import pumpkin.kr.hanbat.navermap.FragmentActivity;
import pumpkin.kr.hanbat.navermap.NMapCalloutCustomOldOverlay;
import pumpkin.kr.hanbat.navermap.NMapCalloutCustomOverlayView;
import pumpkin.kr.hanbat.navermap.NMapPOIflagType;
import pumpkin.kr.hanbat.navermap.NMapViewerResourceProvider;

/**
 * Created by farid on 2016-04-26.
 */
public class MapActivity extends NMapActivity implements View.OnClickListener {
    private static final String CLIENT_ID = "SflWxQ4wS91i2A7Ua1Dq";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((LinearLayout)findViewById(R.id.map_layout)).addView(mMapContainerView);
    ...
    private final OnDataProviderListener onDataProviderListener = new OnDataProviderListener() {
        ...
        public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
            ...
            Utils.Log("onReverseGeocoderResponse: placeMark=" + ((placeMark != null) ? placeMark.toString() : null));

            if (errInfo != null) {
                Utils.Log("Failed to findPlacemarkAtLocation: error=" + errInfo.toString());
    ...
    private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
        ...
        public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
            ...
            if (errorInfo == null) { // success
                ...
                Utils.Log("onFailedToInitializeWithError: " + errorInfo.toString());
        ...
        public void onAnimationStateChange(NMapView mapView, int animType, int animState) {
            Utils.Log("onAnimationStateChange: animType=" + animType + ", animState=" + animState);
        }

        @Override
        public void onMapCenterChange(NMapView mapView, NGeoPoint center) {
            Utils.Log("onMapCenterChange: center=" + center.toString());
        }

        @Override
        public void onZoomLevelChange(NMapView mapView, int level) {
            Utils.Log("onZoomLevelChange: level=" + level);
        }
    ...
    private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
        ...
        public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            Utils.Log("onCalloutClick: title=" + item.getTitle());
        ...
        public void onFocusChanged(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            if (item != null) {
                Utils.Log("onFocusChanged: " + item.toString());
            } else {
                Utils.Log("onFocusChanged: ");
            }
        }
    };
    ...
    private final NMapPOIdataOverlay.OnFloatingItemChangeListener onPOIdataFloatingItemChangeListener = new NMapPOIdataOverlay.OnFloatingItemChangeListener() {
        ...
        public void onPointChanged(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            ...
            Utils.Log("onPointChanged: point=" + point.toString());
