...
/**
 * Created by farid on 2016-05-01.
 */
public class MonthlyFragment extends Fragment {
    ...
    public static MonthlyFragment newInstance(int year, int month) {
        Utils.Log(NAME + " newInstance " + year + "/" + month);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Utils.Log(NAME + " onCreate " + mYear + "." + mMonth);
    }
    ...
    class MonthlySlidePagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Utils.Log(NAME + " instantiateItem " + position);
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            Utils.Log(NAME + " destroyItem " + position);
        ...
        public void onPageScrollStateChanged(int state) {
            switch(state) {
                case ViewPager.SCROLL_STATE_IDLE:
                    Utils.Log(NAME + " SCROLL_STATE_IDLE");
                    break;
                case ViewPager.SCROLL_STATE_DRAGGING:
                    Utils.Log(NAME + " SCROLL_STATE_DRAGGING");
                    previousPosition = vvpager.getCurrentItem();
                    break;
                case ViewPager.SCROLL_STATE_SETTLING:
                    Utils.Log(NAME + " SCROLL_STATE_SETTLING");
                    break;
            }
        }
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            if(previousPosition != position) {
                ...
                Utils.Log(NAME + " " + position + " onPageScrolled-  " + ym.year + "." + ym.month);
            }
        }
