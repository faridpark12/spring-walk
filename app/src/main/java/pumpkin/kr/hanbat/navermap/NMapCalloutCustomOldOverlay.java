...
public class NMapCalloutCustomOldOverlay extends NMapCalloutOverlay {
	...
	private void adjustTextBounds(NMapView mapView) {
		...
		if (mTitleTruncated == null || mWidthTitleTruncated != mapViewWidth) {
			...
			Utils.Log("adjustTextBounds: maxWidth=" + maxWidth + ", mMarginX=" + mMarginX + ", mPaddingX=" + mPaddingX);
			...
			Utils.Log("adjustTextBounds: mTitleTruncated=" + mTitleTruncated + ", length=" + mTitleTruncated.length());
		}
		...
		Utils.Log("adjustTextBounds: mTempRect.width=" + mTempRect.width() + ", mTempRect.height=" + mTempRect.height());
